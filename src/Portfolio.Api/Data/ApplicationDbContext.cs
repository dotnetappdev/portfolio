...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Project>().HasData(
            new Project { Id = 1, Title = "BookIt", ShortDescription = "A Blazor booking management application", Description = "BookIt is a full-featured booking management system built with ASP.NET Core Blazor. It allows businesses to manage appointments, resources, and customer bookings with an intuitive and modern interface featuring light and dark mode support. Built from the ground up with a clean architecture, real-time availability tracking, SMS notifications, and a responsive MudBlazor UI.", TechStack = "Blazor, ASP.NET Core, SQL Server, Entity Framework Core, MudBlazor, C# .NET 10", Category = "Work Project", IsFeatured = true, SortOrder = 1, ImageUrl = "/images/bookit.svg" },
            ...
            new Project { Id = 3, Title = "Curo", ShortDescription = "Healthcare care management platform", Description = "Curo is a healthcare care management platform designed to streamline patient care coordination and clinical workflows. Built with Blazor and ASP.NET Core, it provides care plan management, real-time patient tracking, task scheduling for carers, and a live dashboard for care managers. Hosted on Azure with robust authentication and role-based access control.", TechStack = "ASP.NET Core, Blazor, SQL Server, Entity Framework Core, Azure, MudBlazor, C# .NET 10", Category = "Work Project", IsFeatured = true, SortOrder = 3, ImageUrl = "/images/curo.svg" },
            ...
            new Project { Id = 5, Title = "AI Diagnostic Assistant", ShortDescription = "AI powered clinical decision support tool", Description = "An AI assistant integrated into a healthcare platform that helps clinical staff surface relevant patient history, flag anomalies in test results, and draft care plan notes. Built on Semantic Kernel and Azure OpenAI with a strict evaluation layer to prevent hallucinations reaching clinical staff. All AI output is audited and confidence scored before display.", TechStack = "Semantic Kernel, Azure OpenAI, ASP.NET Core, Blazor, SQL Server, Vector Search, .NET 10", Category = "AI", IsFeatured = true, SortOrder = 5, ImageUrl = "/images/ai-assistant.png" },
            new Project { Id = 6, Title = "SecureAPI Framework", ShortDescription = "Hardened API security baseline for .NET", Description = "A reusable security baseline for ASP.NET Core APIs covering JWT authentication with algorithm pinning, OWASP Top Ten mitigations, rate limiting, structured security logging, and automated dependency vulnerability scanning in the CI pipeline. Used as the starting point for all new API projects to ensure security is built in from the first commit rather than retrofitted.", TechStack = "ASP.NET Core, JWT, OAuth2, OWASP, Rate Limiting, Polly, GitHub Actions", Category = "Security", IsFeatured = true, SortOrder = 6, ImageUrl = "/images/secure-api.png" },
            new Project { Id = 7, Title = "TalentConnect", ShortDescription = "A Blazor recruitment management platform", Description = "TalentConnect is a full-featured recruitment management platform built with Blazor and ASP.NET Core. It streamlines the end-to-end hiring process with job posting management, a multi-stage candidate pipeline, interview scheduling, automated email and SMS notifications, and detailed recruitment analytics. Designed for recruitment teams who need a fast, modern, and data-driven hiring workflow.", TechStack = "Blazor, ASP.NET Core, SQL Server, Entity Framework Core, MudBlazor, REST API, C# .NET 10", Category = "Work Project", IsFeatured = true, SortOrder = 7, ImageUrl = "/images/talentconnect.svg" }
        );
